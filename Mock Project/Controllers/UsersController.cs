...
//                    Gallery = new List<UserImage>() // Initialize the Gallery property
//                };
...
//                user.Bio = model.Bio;
//                user.ProfilePictureUrl = $"/uploads/{model.File.FileName}";
...
//        [HttpPut]
//        public async Task<IActionResult> UpdateUser([FromForm] UserUpdateRequest model)
//        {
